...
export default function Hero() {
  return ( 
    <div className="flex flex-col text-center justify-center gap-4 items-center mb-100 w-full relative h-[400px] md:h-[633px] bg-remotify-db">
          ...
          <p className="text:md md:text-lg pt-1 md:w-6/12 w-8/12 text-gray-300">Navigate the World of Opportunities with Our Comprehensive Job Portal, Connecting Talented Individuals with their Dream Careers.</p>
