...
export default function SubscribeForm() {
    ...
    const onSubmit = async (data) => {
        ...
        const result = await fetch('/api/subscribe-lead-magnet-cv-guide', {
            method: 'PUT',
            ...
            <div className='lg:flex flex-col w-11/12 md:w-6/12 h-fit my-20 rounded-xl shadow-xl bg-white border-[2px] border-remotify-lb items-center justify-center'>
                <div className='lg:flex flex-col p-4 my-4 mx-2 md:mx-10 pb-0 items-center'>
                    <div className='flex flex-row items-center justify-around'>
                        <h1 className='text-slate-900 text-xl md:text-3xl font-bold text-center'>Get your Remote CV Guide</h1>
                    </div>
                    <p className='text-slate-500 w-full py-8 text-center'>Simply fill in the form below and we&apos;ll send you the guide.</p>
                </div>
                <Form {...form}>
