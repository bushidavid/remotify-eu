  ...
  return (
    <div className='border-b-1 pb-3 border-slate-100 w-full'>
        <div className='flex items-center justify-center flex-col'>
              ...
              <h2 className='px-3 text-md'>{job?.company_name}</h2>
            <div className='flex items-center justify-center mt-4 gap-x-3 flex-wrap text-sm'>
              ...
              <div className="flex flex-row items-center md:border-l-1 pl-2"><FaPersonCane /><p className='px-1 md:border-r-1  border-slate-300'>{job.experience}  </p></div>
